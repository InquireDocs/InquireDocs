...
from app.core.db.postgres_record_manager import RecordManager
...
class PgVectorDb(BaseDatabase):
    ...
    def __init__(self, index_cleanup: str, index_source_id_key: str) -> None:
        ...
        if "pgvector" in settings.available_vector_store_providers:
            ...
            self.collection_name = settings.pgvector_server_collection_name
            ...
            self.record_manager = RecordManager(self.rm_namespace,
                                                index_cleanup,
            ...
            logger.error("PGVector is not available provider. Check the settings and try again.")
