...
def parse_int(value: str):
    """Helper function to parse an integer environment variable with a custom exception."""
    try:
        return int(value)
...
def parse_float(value: str):
    """Helper function to parse an float environment variable with a custom exception."""
    try:
        return float(value)
    except (TypeError, ValueError) as e:
    ...
    def load(self):
        ...
        match self.llm_provider:
            ...
            case "openai":
                ...
                openai_model_temperature: str = parse_float(os.getenv('OPENAI_MODEL_TEMPERATURE', '0'))
